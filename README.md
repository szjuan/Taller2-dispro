...
**Archivo:** `SolucionTaller/Punto5/Run_Punto5A.c`
...
El programa imprime directamente el JSON listo para pegar en [wavedrom.com](https://wavedrom.com/) para su comparación con el diagrama de tiempo del datasheet, este contiene:

- Señales de entrada del CI.
- Salidas paralelas con soporte de alta impedancia (`x`) y `QH'`.

A continuación se encuentra la imagen del diagrama de tiempo generado:
![Rta Punto 5](ImgsReadme/ResP5.png)

Esta se puede comparar el diagrama original del datasheet que se muestra a continuación:
...
| `Run_Punto_Taller5a`   | XXXXX                                                                                                                 |
| `QuieroSacar5EnDispro` | XXXXX                                                                                                                 |
